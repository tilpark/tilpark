	    ...
	    <div class="row">
	        ...
	        <div class="col-md-6">
	            <div class="form-group">
	                ...
	                <div class="input-prepend input-group">
	                    <span class="input-group-addon"><span class="fa fa-user"></span></span>
	                    <input type="hidden" id="receiver_user_id" name="receiver_user_id" value="" class="required" />
	                    <input type="text" id="receiver_user" name="receiver_user" class="form-control required" placeholder="Alıcı" maxlength="32" value="" autocomplete="off" />
	                </div>
