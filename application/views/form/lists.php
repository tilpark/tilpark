...
<table class="table table-bordered table-hover table-condensed dataTable">
	<thead>
    	<tr>
            ...
            <th width="50">G/Ç</th>
            <th>Hesap Kartı</th>
            <th width="50">Ürünler</th>
            <th width="100">Genel Toplam</th>
        </tr>
    </thead>
    <tbody>
    <?php 
    ...
    <?php foreach($invoices as $invoice): ?>
    	<tr>
            ...
            <td><a href="<?php echo site_url('account/view/'.$invoice['account_id']); ?>" target="_blank"><?php echo @$accounts[$invoice['account_id']]['name']; ?></a></td>
