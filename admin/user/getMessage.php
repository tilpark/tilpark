...
if ( $_GET['get_message'] == "old" AND isset($_GET['list_old_message']) ) {
  ...
  $get_query = " (type='". $_GET['type'] ."' OR type='". $or_type ."') AND (rec_u_id = '". get_active_user('id') ."' OR sen_u_id = '". get_active_user('id') ."' ) AND (top_id='". $_GET['query_message'] ."' OR id='". $_GET['query_message'] ."') AND date < '". $get_message->date ."' ORDER BY date DESC, id DESC LIMIT 3";
