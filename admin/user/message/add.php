					...
					<div class="row space-5">
						...
						<div class="col-md-11">
							<div class="form-group message-area">
								...
								<script>editor({selector: "#message", plugins: 'autolink table textcolor colorpicker image textpattern', toolbar: 'bold italic underline forecolor backcolor image table link', height: '160' });</script>
							</div> <!-- /.form-group -->
