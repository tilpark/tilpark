...
<div class="row">
	...
	<div class="col-md-6">
		...
		<?php $q_form_items = db()->query("SELECT * FROM ".dbname('form_items')." WHERE form_id='".$monthly->id."' AND status='1' "); ?>
					...
					<tbody>
						<?php while($item = $q_form_items->fetch_object() ): ?>
							<tr>
								...
								<td><?php echo til_get_date($item->date, 'datetime'); ?></td>
								<td>
									<?php if($item->item_name == 'monthly_day'): ?>
								...
								<td class="text-center">
									...
									<?php if($item->item_name == 'monthly_day' OR $item->item_name == 'did_not_come') { echo ' gün'; } else { echo ' saat'; } ?>
								</td>
