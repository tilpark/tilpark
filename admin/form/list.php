				...
				<?php foreach($forms->list as $form): ?>
					...
					<tr>
						...
						<td class="hidden-xs-portrait">
							<span class="label label-primary" data-toggle="tooltip" title="<?php echo $form_status->name; ?>" style="background-color:<?php echo $form_status->bg_color; ?>; color:<?php echo $form_status->color; ?>;"><?php echo til_get_abbreviation($form_status->name); ?></span>
						</td>
		...
		<?php if($forms): ?>
			<table class="table table-hover table-bordered table-condensed table-striped">
				...
				<?php foreach($forms->list as $form): ?>
					...
					<tr>
						<td><a href="detail.php?id=<?php echo $form->id; ?>">#<?php echo $form->id; ?></a></td>
						<td><span class="label label-primary" style="background-color:<?php echo $form_status->bg_color; ?>; color:<?php echo $form_status->color; ?>;"><?php echo $form_status->name; ?></span></td>
